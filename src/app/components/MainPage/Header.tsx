...
const StartButton: FC = () => {
  ...
  return (
    <a href="/en/home" className="block px-4 py-3 mt-10 text-lg font-bold text-white uppercase bg-gray-800 hover:bg-gray-900">
      {t('startBtn')}
    </a>
  );
};
...
const Header: FC = () => {
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      <div className="absolute inset-0 bg-black opacity-25 bg-white dark:bg-gray-800">
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 overflow-hidden relative">
        <div className="container relative z-10 flex items-start px-6 py-32 mx-auto">
          <div className="relative w-1/2 z-10 flex flex-col items-start ml-10">
            <h1 className="font-extrabold leading-tight text-start text-gray-800 text-7xl sm:text-8xl">
              {t('header.title')}
            </h1>
            <StartButton />
          </div>
