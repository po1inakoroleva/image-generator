...
const About: FC = () => {
  ...
  return (
    <div className="relative max-w-screen-xl p-4 px-4 mb-20 mx-auto bg-white dark:bg-gray-800 sm:px-6 lg:px-8 py-26 lg:mt-20">
      ...
      <div className="flex justify-center">
        <a href="https://github.com/po1inakoroleva" target="_blank">
          <img src="/images/github-mark.svg" className="mt-10 max-w-md lg:block" />
        </a>
      </div>
    </div>
  );
